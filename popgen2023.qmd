...
::: aside
**Note:** You can specify events in more natural "units of years ago". Just program times in a "decreasing order" (7Mya → 6Mya → ..., as shown in the picture above).
:::
...
<center><h2>Now we can simulate data.<br>How do we work with this `ts` thing?</h2></center>
:::
