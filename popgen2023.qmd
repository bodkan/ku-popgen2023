...
Save it in a different script&mdash;you will use it in later exercises.
...
::: aside
[Don't panic---you can use bits of my earlier example AFS code as LEGO pieces.]
:::
...
If you're totally lost, build `model2.R` from this "template":
...
<br>
In a _slendr_ script with your model, you can do this:
<br>
