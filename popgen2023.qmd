...
Open the two red-highlighted links.

<center>![](images/github.png)</center>
...
In a new script `model2.R` write a function taking `Ne` as its only parameter.
...
::: fragment
<br>When used in R, it should work like this:
...
simulate_afs <- function(Ne) {
  <... AFS simulation code you adapted from my slides ...>
  
  result <- ts_afs(...) # use this as shown in the example
  return(result)
}
