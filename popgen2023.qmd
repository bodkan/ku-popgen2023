...
Save it all in a different R script&mdash;you will use it in a later exercise.
...
Simulate a 50Mb tree sequence `ts` from your introgression model in `model1.R` using `msprime()`.
