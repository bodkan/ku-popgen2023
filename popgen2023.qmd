...
- You've learned about symmetries in $f_4$ depending on the arrangement of the "quartet". **How many unique $f_4$ values involving a quartet can you find and why?** (When computing `ts_f4()` here, set `mode = "branch"`).
