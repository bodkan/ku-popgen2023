...
::: fragment
You can specify events in "units of years ago"! Just write times in a "decreasing order" (i.e. present-day will be at time 0).
:::
...
::: aside
See [`ex2_simple.R` script](https://github.com/bodkan/ku-popgen2023/blob/main/solutions/ex2_simple.R) for a simple solution and [`ex2_grid.R` script](https://github.com/bodkan/ku-popgen2023/blob/main/solutions/ex2_grid.R) for a more elaborate grid-search solution.
:::
