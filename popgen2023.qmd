...
<br>They are <u>very</u> powerful but both require:
...
::: aside
**Note:** With _slendr_, you can specify events in more natural "units of years ago". Just program times in a "decreasing order" (7Mya → 6Mya → ..., as shown in the picture above).
:::
...
<center>**Do your results fit expectations from your model?**</center>
...
#| output-location: fragment
#| echo: false
ts_genotypes(ts) %>% as.data.frame() %>% head(5)
```
